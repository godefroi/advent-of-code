...
public partial class Problem
{
	...
	public class Tests
	{
		...
		[InlineData(4, "???.?", 1, 1)]
		[InlineData(12, "??#???#?????.?", 5, 1, 1)]
		[InlineData(1, "???.###????.###????.###????.###????.###", 1,1,3,1,1,3,1,1,3,1,1,3,1,1,3)]
		[InlineData(16384, ".??..??...?##.?.??..??...?##.?.??..??...?##.?.??..??...?##.?.??..??...?##.", 1,1,3,1,1,3,1,1,3,1,1,3,1,1,3)]
		[InlineData(1, "?#?#?#?#?#?#?#???#?#?#?#?#?#?#???#?#?#?#?#?#?#???#?#?#?#?#?#?#???#?#?#?#?#?#?#?", 1,3,1,6,1,3,1,6,1,3,1,6,1,3,1,6,1,3,1,6)]
		public void SolveWorks(int solutionCount, string chars, params int[] groups) =>
			Assert.Equal(solutionCount, Solve(chars.AsSpan(), groups.AsSpan(), []));
		...
		[InlineData("?#?##.", 5, true)]
		[InlineData("#?#?#", 1, true)]
		public void CanBuildGroupWorks(string chars, int groupSize, bool canBuid) =>
			Assert.Equal(canBuid, CanBuildGroup(chars.AsSpan(), groupSize));
	}
}
